  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" onclick="window.location.href='./addmeds.php';" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      ...
      <div class="modal-footer">
        <button onclick="window.location.href='./addmeds.php';" type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
      </div>
    </div>
  </div>
</div>
		...
		<div class="head-title">
			<div class="left">
				...
				<ul class="breadcrumb">
					...
					<li>
						<a class="active" href="./addmeds.php">Add Medicine</a>
					</li>
				</ul>
			</div>
		</div>
                    ...
                    <form action="../addmedicine.php" method="post" enctype="multipart/form-data">
                        <div class="d-flex flex-column align-items-start mb-4">
                            ...
                            <div class="d-flex flex-column align-items-start mb-3" style="width: 80vw;">
                                <input type="text" class="form-control mb-2" name="meds_name">
                            </div>
                            ...
                            <div class="mb-3" style="width: 80vw;">
                                <input type="text" placeholder="e.g Urgent / Not Urgent" class="form-control mb-2" name="urgent">
                            </div>
