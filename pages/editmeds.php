...
$carimeds = "SELECT * FROM reminders WHERE id = '$id'";
$result = mysqli_query($conn, $carimeds);
...
$Query = mysqli_query($conn, "SELECT * FROM reminders WHERE meds_for = '$Email'");
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" onclick="window.location.href='./editmeds.php?id=<?= $medicine['id']?>';" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      ...
      <div class="modal-footer">
        <button onclick="window.location.href='./editmeds.php?id=<?= $medicine['id']?>';" type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
      </div>
    </div>
  </div>
</div>
	...
	<main id="main-content">
		<div class="head-title">
			<div class="left">
				...
				<ul class="breadcrumb">
					<li>
						<a href="./home.php">Medicine</a>
					</li>
					<li><i class='bx bx-chevron-right' ></i></li>
					<li>
						<a class="active" href="./addmeds.php">Edit Medicine</a>
					</li>
				</ul>
			</div>
		</div>
		...
		<section class="pt-6 position-relative">  
            <div class="position-relative border-radius-xl overflow-hidden me-3" id="filter-card">
                <div class="container-fall">
                    <form action="../updatemeds.php" method="post" enctype="multipart/form-data">
                        <div class="d-flex flex-column align-items-start mb-4">

                            <input type="hidden" name="id" value="<?php echo $meds['id']; ?>">
                            <!-- Medicine Name -->
                            <h5 id="teksbpm">Medicine Name</h5>
                            <div class="d-flex flex-column align-items-start mb-3" style="width: 80vw;">
                                <input type="text" class="form-control mb-2" value="<?php echo $meds['nama_obat'] ?>" name="meds_name">
                            </div>

                            <!-- Time Picker (24-hour format) -->
                            <h5 id="teksbpm">At What Time You Should Take It?</h5>
                            <div class="mb-3" style="width: 80vw;">
                                <!-- Set the time input type to ensure 24-hour format -->
                                <input type="time" class="form-control mb-2"  value="<?php echo $meds['waktu'] ?>" name="time" required>
                            </div>

                            <!-- Urgency -->
                            <h5 id="teksbpm">Urgency</h5>
                            <div class="mb-3" style="width: 80vw;">
                                <input type="text" placeholder="e.g Urgent / Not Urgent"  value="<?php echo $meds['urgent'] ?>" class="form-control mb-2" name="urgent">
                            </div>

                            <!-- Note -->
                            <h5 id="teksbpm">Note</h5>
                            <div class="mb-3" style="width: 80vw;">
                                <textarea class="form-control" rows="5" name="note"><?php echo $meds['catatan'] ?></textarea>
                            </div>
